        ...
        <div class="row mt-5">
            ...
            <div class="col-md-9">
                <div class="content-card">
                    <h3 class="text-center mb-4">更新用户信息</h3>
                    ...
                    <form action="<%=request.getContextPath()%>/UpdateUserServlet" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="password" id="password" name="password" value="${user.passwords}" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="birthday" name="birthday" value="${user.birthday}" 
                                    class="form-control form_date" placeholder="请选择生日">
                            </div>
                        </div>
